...
const Card = ({ purchase }) => {
  ...
  return (
    ...
    >
      {/* Card Content */}
      <div>
        <p className="text-2xl font-bold capitalize text-transparent bg-clip-text btn btn-brand">
          {purchase.name}
        </p>
      ...
      <div className="mt-4">
        <NavLink    to={`/details/${purchase._id}`}>
            <button
          className="w-full py-2 btn btn-brand text-white font-semibold rounded-lg transition duration-300"
