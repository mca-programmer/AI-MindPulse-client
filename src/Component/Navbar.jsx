...
export default function Navbar() {
  ...
  className={({ isActive }) =>
    `relative px-4 py-2 font-medium transition-colors ${
      isActive
        ? "text-sky-500 after:content-[''] after:block after:w-full after:h-[2px] after:bg-sky-500 after:mt-1"
...
>
  ...
  return (
    <header className="sticky top-0 z-50">
          ...
          >
            {isDarkMode ? (
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5">
                <path fill="currentColor" d="M12 18a6 6 0 1 1 0-12 6 6 0 0 1 0 12Zm0 2.5a.75.75 0 0 1 .75.75v1a.75.75 0 0 1-1.5 0v-1A.75.75 0 0 1 12 20.5Z" />
              </svg>
            ) : (
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5">
                <path fill="currentColor" d="M21.752 15.002a9.718 9.718 0 0 1-4.094 1.876c-5.186 1.21-9.955-3.56-8.744-8.744A9.72 9.72 0 0 1 10.79 4.04a.75.75 0 0 0-.672-1.125A10.998 10.998 0 1 0 22.877 13.88a.75.75 0 0 0-1.125-.672Z" />
              </svg>
            )}
          </button>
          ...
          {user ? (
            <div className="dropdown dropdown-end">
              ...
              <ul tabIndex={0} className="mt-3 z-[1] p-2 shadow-xl menu menu-sm dropdown-content glass rounded-box w-64">
                ...
                <li>
                  <NavLink to="/purchase" className="justify-between">Purchase Page<span className="badge chip">Click</span></NavLink>
                  <NavLink to="/models" className="justify-between">My Models<span className="badge chip">My Models</span></NavLink>
                </li>
                <li>
            ...
            <NavLink to="/login" className="btn btn-brand rounded-full normal-case shadow-md hover:shadow-lg">Login</NavLink>
          )}
      ...
      {/* Mobile drawer */}
      <div
        className={`lg:hidden fixed left-0 right-0 top-[64px] z-50 transition-all duration-300 ${open ? "opacity-100 translate-y-0" : "-translate-y-4 opacity-0 pointer-events-none"}`}
      >
